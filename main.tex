...
% \section{Appendix B: Fun facts}

% \begin{figure*}[ht]
%  \centering 
%  \includegraphics[width=.5\textwidth]{pictures/fun_facts.png}
%  \caption[fun facts]{Fun list of people who provide 1000 the value of a graduate student to society, according to their salary, as of 2023.}
%  \label{fig:hmmm}
% \end{figure*}
